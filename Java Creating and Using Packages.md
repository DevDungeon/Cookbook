...
# Or the classpath can be set as an environment variable
    ...
    export CLASSPATH=classes/:/path/to/Some.jar:/path/to/dir/of/jars/*

# Then run java and specify the class to execute

    # As long as the classes exist in CLASSPATH
    java com.devdungeon.portscanner.Main
    java MyTestClass

    # Or with an executable JAR
    java -jar MyJar.jar
